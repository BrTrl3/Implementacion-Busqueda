...
```bash
git clone [https://github.com/BrTrl3/Implementacion-Busqueda.git](https://github.com/BrTrl3/Implementacion-Busqueda.git)
cd Taller6-EstructuraDatos
```
---

### 7. Importar en el IDE

> Abre **IntelliJ IDEA** o **Visual Studio Code**.
>
> Importa el proyecto `Taller6-EstructuraDatos` como un proyecto existente (ya sea como proyecto Maven, Gradle, o simplemente una carpeta de código fuente Java).

---


### 7.1 Ejecutar la Clase Principal


> * **Navega a la clase:** `src/main/java/edu/unl/cc/SearchDemo.java`.
